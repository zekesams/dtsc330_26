...
## Homework 12:
Spam email classifier performance with exisiting features: 88.85% with logistic regression and 90.45% with random forest
Spam email classifier performance with existing + new features ('caps_ratio' and 'url_count'): 98.9% with logistic regression and 99.1% with random forest